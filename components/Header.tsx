    ...
    <header className="bg-white shadow-sm border-b border-gray-200">
      <div className="flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center">
          ...
          <h1 className="ml-2 text-2xl font-semibold text-gray-900 lg:ml-0">Dashboard</h1>
        </div>
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            type="button"
            className="p-2 text-gray-400 hover:text-gray-500 hover:bg-gray-100 rounded-full transition-colors duration-200 relative"
          >
          ...
          <div className="relative">
            <div className="flex items-center space-x-3">
              ...
              <div className="relative">
                <button
                  type="button"
                  className="flex items-center space-x-2 p-2 text-sm bg-white rounded-full hover:bg-gray-50 transition-colors duration-200"
